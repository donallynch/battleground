<div id="learn-more-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="learn-more-modal" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="border-bottom: 0px solid transparent; padding-bottom: 0;">
